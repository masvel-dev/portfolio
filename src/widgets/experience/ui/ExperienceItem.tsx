    ...
    <div className="relative flex flex-col md:flex-row md:gap-8 lg:gap-14 space-y-4 md:space-y-0">
      <div className="md:w-1/3">
        <div className="relative sticky top-10 flex flex-col font-bold space-y-1 pl-12 lg:pl-16
          before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[26px] before:h-[26px]
          before:bg-accent before:rounded-full before:border-4 before:border-bg before:transition-colors before:duration-300"
        >
