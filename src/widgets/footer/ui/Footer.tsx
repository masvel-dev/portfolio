      ...
      <Container>
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-6">
          ...
          <div className="flex items-center gap-4 order-1 sm:order-2">
            <span className={`text-gray-500 dark:text-gray-300/80 transition-colors duration-300 text-sm opacity-90 
              after:content-['—'] after:pl-4 hidden sm:block`}>Get in touch</span>
