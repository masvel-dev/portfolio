...
export function Counter({
  ...
  return (
    <div
      ref={ref}
      className="flex items-center gap-3 bg-white/75 py-6 px-4 rounded-md border-b-[3px] border-accent shadow-md backdrop-blur-sm"
    >
      <h2 className="relative text-center">
        <span className="invisible">{value}{suffix}</span>
        <span className="absolute inset-0 text-accent">{count}{suffix}</span>
      </h2>
